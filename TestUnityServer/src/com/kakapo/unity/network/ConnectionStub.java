  ...
  implements Connection
{
  ...
  private String extensionOrServerName;
    ...
    try
    {
      if (!(message instanceof KeepAliveMessage))
      {
        if ((message instanceof RegisterMessage))
        {
          ...
          this.extensionOrServerName = rm.getExtension().toString();
  ...
  {
    return this.extensionOrServerName;
  }
  ...
  {
    return getClass().getSimpleName() + " Group: " + this.group + " Extn: " + this.extensionOrServerName;
  }
