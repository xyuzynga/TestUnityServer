 ...
 * have any questions.
 */
package com.kakapo.unity.server.cryptography.misc;
 ...
 * methods in this class. <DL> <DD>bytesPerAtom which tells the encoder how many
 * bytes to send to encodeAtom <DD>encodeAtom which encodes the bytes sent to it
 * as text. <DD>bytesPerLine which tells the encoder the maximum number of bytes
 * per line. </DL>
 *
...
public abstract class CharacterEncoder {
    ...
    /**
     * Return a byte array from the remaining bytes in this ByteBuffer. <P> The
     * ByteBuffer's position will be advanced to ByteBuffer's limit. <P> To
     * avoid an extra copy, the implementation will attempt to return the byte
     ...
     * OutputStream <i>aStream</i>. <P> The ByteBuffer's position will be
     * advanced to ByteBuffer's limit.
     *
     * @param aBuffer
     * @param aStream
     * @throws IOException
     ...
     * returns a string containing the encoded buffer. <P> The ByteBuffer's
     * position will be advanced to ByteBuffer's limit.
     *
     * @param aBuffer
     * @return
     */
