...
import com.kakapo.unity.message.server.error.ClientBlackListedMessage;
...
import com.kakapo.unity.message.server.error.InvalidKempMessage;
import com.kakapo.unity.message.server.error.MaximumAttemptsMessage;
import com.kakapo.unity.message.server.error.MaximumFrequencyMessage;
import com.kakapo.unity.message.server.error.OverrideMessage;
import com.kakapo.unity.message.server.error.ScheduleStatusOverlap;
import com.kakapo.unity.message.server.error.ShutDownMessage;
            ...
            if ("KeepAlive".contentEquals(property.value)) {
                ...
                switch (number) {
                    case 1:
                        ...
                        break;
                    case 2:
                        result = new ClientBlackListedMessage();
                        break;
                    case 3:
                        result = new ScheduleStatusOverlap();
                        break;                        
                    case 4:
                        result = new InvalidKempMessage();
                        break;
                    case 5:
                        result = new MaximumFrequencyMessage();
                        break;
                    case 6:
                        result = new MaximumAttemptsMessage();
                        break;
                    case 7:
